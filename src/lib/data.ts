...
export const PRODUCTS = [
  {
    ...
    limited: false,
    sizes: {
      '36': 1, '36.5': 1, '37': 1, '38': 1, '38.5': 1,
      '39': 1, '39.5': 1, '40': 1, '40.5': 1, '41': 1,
      '41.5': 0, '42': 1, '43': 0, '44': 0
    }
  },
  {
    id: 'camo',
    ...
    sizes: {
      '36': 1, '36.5': 1, '37': 1, '38': 1, '38.5': 1,
      '39': 1, '39.5': 1, '40': 1, '40.5': 1, '41': 0,
      '41.5': 1, '42': 1, '43': 1, '44': 0
    }
  },
  {
    id: 'yellow',
  ...
  },
  {
    ...
    limited: true,
    sizes: {
      '36': 2, '36.5': 0, '37': 1, '38': 2, '38.5': 2,
      '39': 2, '39.5': 0, '40': 1, '40.5': 0, '41': 0,
      '41.5': 1, '42': 0, '43': 0, '44': 1
    }
  },
  {
    ...
    limited: true,
    sizes: {
      '36': 0, '36.5': 0, '37': 0, '37.5': 2, '38': 3,
      '38.5': 2, '39': 1, '39.5': 1, '40': 1, '40.5': 0,
      '41': 1, '41.5': 0, '42': 2, '43': 1, '44': 0
    }
  }
];
...
export function getShippingCost(country: string): number {
  ...
  if (['Verenigde Staten', 'Verenigd Koninkrijk'].includes(country)) {
    return 33;
  }
...
export const COUNTRIES = [
  ...
  "Antigua en Barbuda", "Argentinië", "Armenië", "Azerbeidzjan",
  "Bahama's", "Bahrein", "Bangladesh", "Barbados", "Belize",
  "Benin", "Bhutan", "Bolivia", "Bosnië en Herzegovina",
  "Botswana", "Brazilië", "Brunei", "Bulgarije", "Burkina Faso",
  "Burundi", "Cambodja", "Centraal-Afrikaanse Republiek", "Chili",
  "China", "Colombia", "Comoren", "Congo-Brazzaville",
  "Congo-Kinshasa", "Costa Rica", "Cuba", "Cyprus", "Denemarken",
  "Djibouti", "Dominica", "Dominicaanse Republiek", "Ecuador",
  "Egypte", "El Salvador", "Equatoriaal-Guinea", "Eritrea",
  "Estland", "Eswatini", "Ethiopië", "Fiji", "Filipijnen",
  "Finland", "Gabon", "Gambia", "Georgië", "Ghana", "Grenada",
  "Griekenland", "Guatemala", "Guinee", "Guinee-Bissau", "Guyana",
  "Haïti", "Honduras", "Hongarije", "Ierland", "IJsland", "India",
  "Indonesië", "Irak", "Iran", "Israël", "Ivoorkust", "Jamaica",
  "Japan", "Jemen", "Jordanië", "Kaapverdië", "Kameroen",
  "Kazachstan", "Kenia", "Kirgizië", "Kiribati", "Koeweit",
  "Kroatië", "Laos", "Lesotho", "Letland", "Libanon", "Liberia",
  "Libië", "Liechtenstein", "Litouwen", "Luxemburg", "Madagaskar",
  "Malawi", "Malediven", "Maleisië", "Mali", "Malta", "Marokko",
  "Marshalleilanden", "Mauritanië", "Mauritius", "Mexico",
  "Micronesië", "Moldavië", "Monaco", "Mongolië", "Montenegro",
  "Mozambique", "Myanmar", "Namibië", "Nauru", "Nepal", "Nicaragua",
  "Nieuw-Zeeland", "Niger", "Nigeria", "Noord-Korea",
  "Noord-Macedonië", "Noorwegen", "Oeganda", "Oekraïne", "Oezbekistan",
  "Oman", "Oostenrijk", "Oost-Timor", "Pakistan", "Palau", "Panama",
  "Papoea-Nieuw-Guinea", "Paraguay", "Peru", "Polen", "Portugal",
  "Qatar", "Roemenië", "Rusland", "Rwanda", "Saint Kitts en Nevis",
  "Saint Lucia", "Saint Vincent en de Grenadines", "Salomonseilanden",
  "Samoa", "San Marino", "Sao Tomé en Principe", "Saoedi-Arabië",
  "Senegal", "Servië", "Seychellen", "Sierra Leone", "Singapore",
  "Slovenië", "Slowakije", "Soedan", "Somalië", "Sri Lanka",
  "Suriname", "Syrië", "Tadzjikistan", "Tanzania", "Thailand",
  "Togo", "Tonga", "Trinidad en Tobago", "Tsjaad", "Tsjechië",
  "Tunesië", "Turkije", "Turkmenistan", "Tuvalu", "Uruguay",
  "Vanuatu", "Vaticaanstad", "Venezuela", "Verenigde Arabische Emiraten",
  "Vietnam", "Wit-Rusland", "Zambia", "Zimbabwe", "Zuid-Afrika",
