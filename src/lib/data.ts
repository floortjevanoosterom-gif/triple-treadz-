...
export const PRODUCTS = [
  {
    id: 'denim',
    ph: 'ph-denim',
    img: '/images/custum denim adidas superstar foto 1.jpg',
    images: [
      '/images/custum denim adidas superstar foto 1.jpg',
  ...
  },
  {
    id: 'yellow',
    ph: 'ph-yellow',
    img: '/images/custom yellow adidas superstar limted edition foto 1.jpg',
    images: [
      '/images/custom yellow adidas superstar limted edition foto 1.jpg',
      '/images/custom yellow adidas superstar limited editon foto 2.jpg'
    ],
    name: {
  ...
  },
  {
    id: 'denim-yellow-le',
    ph: 'ph-yellowdenim',
    img: '/images/custom denim yellow adidas superstar limited edition foto 1.jpg',
    images: [
      '/images/custom denim yellow adidas superstar limited edition foto 1.jpg',
      '/images/custom denim  yellow adidas superstar limited edition foto 2.jpg'
    ],
    name: {
  ...
  },
  {
    ...
    ph: 'ph-blackred',
    img: '/images/custom denim black red adidas superstar limited edition.jpg',
    images: [
      '/images/custom denim black red adidas superstar limited edition.jpg'
    ],
    name: {
...
PRODUCTS.forEach((p) => {
  ...
  Object.keys(p.sizes)
    ...
    .forEach((key) => {
      sortedSizes[key] = p.sizes[key as keyof typeof p.sizes];
    });
...
export const IBAN = 'NL05 INGB 0792 9909 35';export const PAYPAL_EMAIL = 'dvennmedia@gmail.com';
